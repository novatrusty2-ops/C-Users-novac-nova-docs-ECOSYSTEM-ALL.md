...
| Domain | [signetwallet.com](https://signetwallet.com) · [novablockchain.it.com](https://novablockchain.it.com) | Nova mobile / `llc.anakatech.novawallet` |
...
| Deploy | `/var/www/.../signet` + GitHub Pages | `/var/www/.../nova` |
