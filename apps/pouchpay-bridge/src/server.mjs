...
async function handle(req, res) {
  ...
  // CORS preflight — HTTP 200 (project contract: green surfaces return 200)
  if (req.method === "OPTIONS") return json(res, 200, { ok: true, status: "green", httpStatus: 200 });
  ...
  if (path === "/v1/tokens" && req.method === "GET") {
    ...
    return json(res, 200, {
      ...
      nativeFullProduction: true,
      nativeAliases: { ETH: "WETH", BNB: "WBNB", TRX: "WTRX" },
      appVersion: "31.195",
      versionCode: 31195,
      liveBuild: "31.195",
